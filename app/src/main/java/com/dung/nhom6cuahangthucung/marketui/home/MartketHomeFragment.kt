package com.dung.nhom6cuahangthucung.marketui.home
...
class MartketHomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        root = inflater.inflate(R.layout.fragment_market_home, container, false)
